...
function Terms() {
  return (
    <>
      ...
      <ContentWrapper>
        <Text>1. You can try PageWatcher 14 days for free;</Text>

        <Text margin="1rem 0 0">2. You can buy tickets to continue using PageWatcher;</Text>

        <Text margin="1rem 0 0">
          3. After your account is expired, you can't create new watchers, you can't update or
          delete existing watchers, PageWatcher will also stop checking the websites in the
